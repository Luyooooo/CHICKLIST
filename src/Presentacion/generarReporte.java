...
public class generarReporte extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Reporte.setBackground(new java.awt.Color(255, 102, 102));
        Reporte.setColumns(20);
        Reporte.setForeground(new java.awt.Color(255, 255, 255));
        Reporte.setRows(5);
        jScrollPane1.setViewportView(Reporte);

        jPanel2.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 50, 220, 100));
        ...
        jPanel2.add(GenerarReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 103, 120, 50));
        ...
        jPanel2.add(GuardarArchivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 203, 150, 60));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 310, 140, 50));
    ...
    private void GenerarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_GenerarReporteActionPerformed
        ...
        Logica.ReporteDiario reporte = new Logica.ReporteDiario(ventas, pagos);

        Reporte.append(reporte.generarResumenTexto());
