...
public class RegistrarVenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fondo.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 140, -1, -1));
        ...
        fondo.add(ProductoField, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 190, 280, 30));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Cantidad:");
        fondo.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, -1, -1));
        ...
        fondo.add(CantidadField, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 180, 30));

        CedulaField.setBackground(new java.awt.Color(255, 255, 255));
        CedulaField.setText("Ingrese el numero de cedula");
        fondo.add(CedulaField, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 280, 30));

        PagadoCheckbox.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        PagadoCheckbox.setLabel("Pagado");
        fondo.add(PagadoCheckbox, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 130, -1, -1));
        ...
        fondo.add(AgregarProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 270, -1, -1));
        ...
        fondo.add(RegistrarVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 350, -1, -1));

        Resumen.setBackground(new java.awt.Color(255, 204, 204));
        Resumen.setColumns(20);
        Resumen.setRows(5);
        jScrollPane1.setViewportView(Resumen);

        fondo.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, 280, 160));
        ...
        fondo.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 410, -1, -1));
    ...
    private void AgregarProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarProductoActionPerformed
        ...
        Resumen.append("*" + encontrado.getNombre() + " x" + cantidad + "\n");
